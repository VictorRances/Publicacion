...
fpersonaldelete.ValidateRequired = true;
<?php } else { ?>
fpersonaldelete.ValidateRequired = false; 
<?php } ?>
...
<?php if ($personal->idper->Visible) { // idper ?>
		<th><span id="elh_personal_idper" class="personal_idper"><?php echo $personal->idper->FldCaption() ?></span></th>
<?php } ?>
<?php if ($personal->nombreper->Visible) { // nombreper ?>
		<th><span id="elh_personal_nombreper" class="personal_nombreper"><?php echo $personal->nombreper->FldCaption() ?></span></th>
<?php } ?>
<?php if ($personal->numeroper->Visible) { // numeroper ?>
		<th><span id="elh_personal_numeroper" class="personal_numeroper"><?php echo $personal->numeroper->FldCaption() ?></span></th>
<?php } ?>
<?php if ($personal->correoper->Visible) { // correoper ?>
		<th><span id="elh_personal_correoper" class="personal_correoper"><?php echo $personal->correoper->FldCaption() ?></span></th>
<?php } ?>
<?php if ($personal->contra->Visible) { // contra ?>
		<th><span id="elh_personal_contra" class="personal_contra"><?php echo $personal->contra->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($personal->idper->Visible) { // idper ?>
		<td<?php echo $personal->idper->CellAttributes() ?>>
<span id="el<?php echo $personal_delete->RowCnt ?>_personal_idper" class="personal_idper">
...
<?php } ?>
<?php if ($personal->nombreper->Visible) { // nombreper ?>
		<td<?php echo $personal->nombreper->CellAttributes() ?>>
<span id="el<?php echo $personal_delete->RowCnt ?>_personal_nombreper" class="personal_nombreper">
...
<?php } ?>
<?php if ($personal->numeroper->Visible) { // numeroper ?>
		<td<?php echo $personal->numeroper->CellAttributes() ?>>
<span id="el<?php echo $personal_delete->RowCnt ?>_personal_numeroper" class="personal_numeroper">
...
<?php } ?>
<?php if ($personal->correoper->Visible) { // correoper ?>
		<td<?php echo $personal->correoper->CellAttributes() ?>>
<span id="el<?php echo $personal_delete->RowCnt ?>_personal_correoper" class="personal_correoper">
...
<?php } ?>
<?php if ($personal->contra->Visible) { // contra ?>
		<td<?php echo $personal->contra->CellAttributes() ?>>
<span id="el<?php echo $personal_delete->RowCnt ?>_personal_contra" class="personal_contra">
