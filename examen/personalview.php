...
class cpersonal_view extends cpersonal {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["idper"] <> "") {
			$this->RecKey["idper"] = $_GET["idper"];
			$KeyUrl .= "&amp;idper=" . urlencode($this->RecKey["idper"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["idper"] <> "") {
				...
				$this->RecKey["idper"] = $this->idper->QueryStringValue;
			} elseif (@$_POST["idper"] <> "") {
				$this->idper->setFormValue($_POST["idper"]);
				$this->RecKey["idper"] = $this->idper->FormValue;
			} else {
...
fpersonalview.ValidateRequired = true;
<?php } else { ?>
fpersonalview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($personal->idper->Visible) { // idper ?>
	<tr id="r_idper">
		<td><span id="elh_personal_idper"><?php echo $personal->idper->FldCaption() ?></span></td>
...
<?php echo $personal->idper->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($personal->nombreper->Visible) { // nombreper ?>
	<tr id="r_nombreper">
		<td><span id="elh_personal_nombreper"><?php echo $personal->nombreper->FldCaption() ?></span></td>
...
<?php echo $personal->nombreper->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($personal->numeroper->Visible) { // numeroper ?>
	<tr id="r_numeroper">
		<td><span id="elh_personal_numeroper"><?php echo $personal->numeroper->FldCaption() ?></span></td>
...
<?php echo $personal->numeroper->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($personal->correoper->Visible) { // correoper ?>
	<tr id="r_correoper">
		<td><span id="elh_personal_correoper"><?php echo $personal->correoper->FldCaption() ?></span></td>
...
<?php echo $personal->correoper->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($personal->contra->Visible) { // contra ?>
	<tr id="r_contra">
		<td><span id="elh_personal_contra"><?php echo $personal->contra->FldCaption() ?></span></td>
...
<?php echo $personal->contra->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
