...
define("EW_PROJECT_NAME", "ProyectoExamen", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{33D340AA-42AB-4291-828D-AC1DA9E53193}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'GtbhfVycaa5MiUgx', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/ProyectoExamen.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "76644220", "db" => "examen", "qs" => "`", "qe" => "`");
...
define("EW_USER_TABLE", "`personal`", TRUE);
define("EW_USER_NAME_FILTER", "(`correoper` = '%u')", TRUE);
